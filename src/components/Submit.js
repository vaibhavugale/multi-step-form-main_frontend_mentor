  ...
  return (
    <>
        <div className="content contentFive">
              ...
              <div className='contentFive divOne'>
                   ...
                   <h1>Thank You!</h1>
                   <p>
                  Thank for confirming your subscription! we hope you have fun using our platform. If you ever need  support , please fill free to email us st example@gmail.com 
                </p>
              </div>
